...
public class UserRegistrationErrorDetails {

	private Date timestamp;
	private String details;
	private List<String> messages;

	public UserRegistrationErrorDetails() {
		super();
	}

	public UserRegistrationErrorDetails(Date timestamp, String details, List<String> messages) {
		super();
